    ...
    <el-dialog width="450px" @close="dialogCloseEvent" :model-value="props.modelValue.editInfoVisi" title="Lend a book">
      ...
      >
        ...
        <el-form-item label="patron ID:">
          <el-input v-model="pidInputValue" placeholder="Please input the patron ID"/>
        </el-form-item>


        <el-form-item label="lend days:">
          <el-input-number v-model="lendDaysInputValue" style="width: 100%" disabled
                           placeholder="Input the days you wish to lend"/>
        </el-form-item>
